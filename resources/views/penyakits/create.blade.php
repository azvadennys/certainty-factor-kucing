                    ...
                    <form action="{{ route('penyakits.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="kode_penyakit" class="form-control" id="kode_penyakit"
                                value="{{ $kode_penyakit }}" readonly>
                        </div>
                        <div class="form-group mb-3">
                            <label for="nama_penyakit" class="form-label">Nama Penyakit</label>
                            <input type="text" name="nama_penyakit"
                                class="form-control @error('nama_penyakit') is-invalid @enderror" id="nama_penyakit"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="file" name="foto_penyakit"
                                class="form-control @error('foto_penyakit') is-invalid @enderror" id="foto_penyakit">
                            @error('foto_penyakit')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
