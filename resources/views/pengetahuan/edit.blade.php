        ...
        <div class="col-md-8 col-lg-6">
            <form action="{{ route('pengetahuan.update', $pengetahuan->id) }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="kode_penyakit" id="kode_penyakit" class="form-control select2-penyakit" style="width: 100%;" required>
                        <option value="{{ $pengetahuan->penyakit->kode_penyakit }}">{{ $pengetahuan->penyakit->kode_penyakit }} - {{ $pengetahuan->penyakit->nama_penyakit }}</option>
                    </select>
                    @error('kode_penyakit')
